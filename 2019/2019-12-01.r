REBOL [
    Title: "Advent of Code 2019 - Day 01"
    Author: "Gaetan Barel"
    Version: 1.0.0
...
comment {
    --- Days 1: The Tyranny of the Rocket Equation ---
...
calculate-fuel: func [
    "Calculate the right amount of fuel based on the mass"
    mass [integer!] "The mass of the module"
    /sum "include the fuel for the fuel for the fuel..."
] [
    fuel: (round/down (mass / 3)) - 2
    either ((not none? sum) and (fuel > 0)) [
        fuel: fuel + calculate-fuel/sum fuel 
    ] [
        max fuel 0
    ]
]
...
get-answer: func [
    "Get answer to either puzzle of the day"
    puzzle [number!] "1 or 2"
] [
    input: read/lines %2019-12-01-input.txt
    fuel: 0
    foreach mass-str input [
        mass: to-integer mass-str
        fuel: fuel + either (puzzle == 1) [
            calculate-fuel mass
        ] [
            calculate-fuel/sum mass
        ]
    ] 
    prin "Answer: " print fuel
]
